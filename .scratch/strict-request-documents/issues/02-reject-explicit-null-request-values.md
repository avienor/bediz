...
- Blocking findings: any command accepting a null at any depth; a rejection after a network request; a changed error code or exit status; spec text that disagrees with the tests.

...
const (
	...
	OperationProfilesList    = "profiles.list"
	OperationProfilesGet     = "profiles.get"
	OperationProfilesCreate  = "profiles.create"
	OperationProfilesDelete  = "profiles.delete"
	OperationAuth            = "auth"
	OperationAuthHuggingFace = "auth.huggingface"
	OperationAuthHFStatus    = "auth.huggingface.status"
	OperationAuthHFLogin     = "auth.huggingface.login"
	OperationAuthHFLogout    = "auth.huggingface.logout"
)
